...
```{r}
# Read the CSV files
df_trivy <- read.csv("/Users/gabecowley/Documents/2023SummerResearch/02_Preprocessing/02c_tables/01_input/Trivy/master_dataTrivy.csv")
df_grype <- read.csv("/Users/gabecowley/Documents/2023SummerResearch/02_Preprocessing/02c_tables/01_input/Grype/master_dataGrype.csv")
```
