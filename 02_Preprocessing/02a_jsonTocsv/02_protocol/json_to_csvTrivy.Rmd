...
inputCompletion = paste0(input_name, directoryCompletion1)

# Concatenate the directory path and input file name
file_path <- here(directory_path1, inputCompletion)
...
outputCompletion = paste0(input_name, directoryCompletion2)

# Concatenate the directory path and output file name
file_path <- here(directory_path2, outputCompletion)
